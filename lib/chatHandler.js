...
import { routeIntelligently } from './intelligentRouter.js';
...
export async function handleChat(input, options = {}) {
  ...
  // ============================================================================
  // NEW: Intelligent Router Mode (default)
  // ============================================================================
  if (useIntelligentRouter) {
    try {
      const result = await routeIntelligently(input, {
        context,
        source,
      ...
      console.error('[ChatHandler] Intelligent router failed, falling back to legacy:', error.message);
