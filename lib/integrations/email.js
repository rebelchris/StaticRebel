  ...
  async getEmailStats() {
    ...
    try {
      const stats = db.prepare(`
        SELECT 
          COUNT(*) as total_sent,
          COUNT(CASE WHEN type = 'daily-summary' THEN 1 END) as daily_summaries,
          COUNT(CASE WHEN type = 'weekly-digest' THEN 1 END) as weekly_digests,
          COUNT(CASE WHEN type = 'streak-milestone' THEN 1 END) as streak_notifications,
          COUNT(CASE WHEN type = 'goal-completion' THEN 1 END) as goal_alerts,
