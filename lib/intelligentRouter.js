...
### For use_skill:
- ONLY use skills that EXACTLY match the user's intent
- "water" skill is for WATER intake, not food/calories
- "mood" skill is for MOOD/emotions, not food/calories  
